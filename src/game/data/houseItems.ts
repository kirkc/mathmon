...
export const HOUSE_ITEMS: HouseItem[] = [
  ...
  { id: 'wallart1', name: 'Wall Art: Meadow', price: 20, mapKey: 'playerHouse1', tileX: 4, tileY: 1, textureKey: 'item-wallart-1', solid: false, examine: 'A painting of Meadow Town in spring.' },
  ...
  { id: 'wallart3', name: 'Wall Art: Starters', price: 20, mapKey: 'playerHouse2', tileX: 5, tileY: 1, textureKey: 'item-wallart-3', solid: false, examine: 'A portrait of the three starter MathMon.' },
  ...
  { id: 'chair', name: 'Cozy Chair', price: 35, mapKey: 'playerHouse1', tileX: 9, tileY: 5, textureKey: 'item-chair', solid: true, examine: 'The official thinking chair.' },
  ...
  { id: 'table', name: 'Dining Table', price: 60, mapKey: 'playerHouse1', tileX: 8, tileY: 5, textureKey: 'item-table', solid: true, examine: 'Homework happens here. So do snacks.' },
  { id: 'rug', name: 'Round Rug', price: 70, mapKey: 'playerHouse1', tileX: 5, tileY: 4, textureKey: 'item-rug', solid: false, examine: 'It really ties the room together.' },
  { id: 'wardrobe', name: 'Wardrobe', price: 80, mapKey: 'playerHouse2', tileX: 6, tileY: 2, textureKey: 'item-wardrobe', solid: true, examine: 'Seven identical adventure outfits. Efficient!' },
  { id: 'couch', name: 'Comfy Couch', price: 90, mapKey: 'playerHouse1', tileX: 5, tileY: 5, textureKey: 'item-couch', solid: true, examine: 'Premium napping technology.' },
  { id: 'fireplace', name: 'Fireplace', price: 110, mapKey: 'playerHouse1', tileX: 7, tileY: 2, textureKey: 'item-fireplace', solid: true, examine: 'Crackle, crackle. Cozy and warm.' },
  { id: 'fridge', name: 'Refrigerator', price: 120, mapKey: 'playerHouse1', tileX: 9, tileY: 2, textureKey: 'item-fridge', solid: true, examine: 'Stocked with juice boxes and victory snacks.' },
  { id: 'tv', name: 'Big TV', price: 150, mapKey: 'playerHouse1', tileX: 5, tileY: 2, textureKey: 'item-tv', solid: true, examine: "It's playing a MathMon battle replay!" },
];
...
export const HOUSE_FIXTURES: HouseFixture[] = [
  ...
  { id: 'bed', mapKey: 'playerHouse2', tileX: 2, tileY: 2, textureKey: 'item-bed', solid: true, examine: 'Your cozy bed. Dream of big sums.' },
  { id: 'bed-foot', mapKey: 'playerHouse2', tileX: 2, tileY: 3, textureKey: '', solid: true, examine: 'Your cozy bed. Dream of big sums.' },
];
